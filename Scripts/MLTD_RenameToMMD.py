...
#           ('old name','new name')
# Apostrophe is not omitted. Add comma if there's a new bone you want to rename.
bonenames = [
    ('BASE',                    'ParentNode'),
    ('MUNE1',                   'UpperBody'),
    ('MUNE2',                   'UpperBody2'),
    ...
    ('TE_L',                    'Wrist_L'),
#   ('OYA3_L',                  'Thumb1_L'), # Thumb palm is often omitted from MMD armature
    ...
    ('TE_R',                    'Wrist_R'),
#   ('OYA3_R',                  'Thumb1_R'), # Thumb palm is often omitted from MMD armature
